...
public class UpdateStudentUseCase implements UpdateStudentPort {
    ...
    @Override
    public Student update(int id_student, Integer id_person, Integer id_profesor, SaveStudent saveStudent)
            throws Exception {
    ...
    @Override
    public Student addSubjects(int id_student, List<Integer> id_subject) throws Exception {
        Student student = findStudentPort.findById(id_student);

        Set<Subject> subjects = new HashSet<>();

        for (int s : id_subject) {
    ...
    @Override
    public Student unsubscribeSubjects(int id_student, List<Integer> id_subject) throws Exception {
        Student student = findStudentPort.findById(id_student);
    ...
    @Override
    public Student teacher(int id_student, int id_teacher) throws Exception {
        Student student = findStudentPort.findById(id_student);

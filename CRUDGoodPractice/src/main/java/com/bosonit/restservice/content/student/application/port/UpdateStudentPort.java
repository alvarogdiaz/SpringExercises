...
public interface UpdateStudentPort {
    ...
    Student addSubjects(String id_student, String[] id_subject) throws Exception;
    Student unsubscribeSubject(String id_student, String id_subject) throws Exception;
    Student unsubscribeSubjects(String id_student, String[] id_subject) throws Exception;
